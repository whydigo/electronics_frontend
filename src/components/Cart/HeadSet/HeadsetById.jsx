...
const HeadSetById = () => {
  ...
  const filteredHeadserById = headset.filter((item) => {
    if (!id);
    return item._id === id;
  });
              ...
              <div className="container_productById">
                ...
                <div className="productById_characteristics">
                  ...
                  <div className="productById_description">
                    ...
                    <div className="productById_description_individually"><div className="productById_description_individually_item">совместимость</div><div className="productById_emptiness"></div><div className="productById_description_individually_item_name">{item.compatibility}</div></div>
                    <div className="productById_description_individually"><div className="productById_description_individually_item">тип соединения</div><div className="productById_emptiness"></div><div className="productById_description_individually_item_name">{item.connectType}</div></div>
                    ...
                    <div className="productById_description_individually"><div className="productById_description_individually_item">характерестики</div><div className="productById_emptiness"></div><div className="productById_description_individually_item_name">{item.characteristics}</div></div>
						  <div className="productById_description_individually"><div className="productById_description_individually_item">технические особенности</div><div className="productById_emptiness"></div><div className="productById_description_individually_item_name">{item.techFeatures}</div></div>
